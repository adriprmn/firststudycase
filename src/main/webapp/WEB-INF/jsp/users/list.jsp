...
<div class="mdl-layout mdl-js-layout mdl-color--grey-100 box-center">
    <main class="mdl-layout__content">
        <input type="button" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" value="add user" onclick="window.location.href='form'; return false;" />
        ...
        <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
            ...
            <c:forEach items = "${users}" var="user">
                <c:url var="updateLink" value="form" >
                    <c:param name="id" value="${user.getId()}"></c:param>
                </c:url>

                <c:url var="deleteLink" value="delete"></form>" >
                    <c:param name="id" value="${user.getId()}"></c:param>
                </c:url>
